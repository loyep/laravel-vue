...
function ncPopupTips (type, msg) {
  ...
  var html = `<section class="nice-tips ${c} nice-tips-sm nice-tips-open"><div class="nice-tips-overlay"></div><div class="nice-tips-body text-center"><div class="nice-tips-content px-5">${ico}<p class="text-md">${msg}</p></div></div></section>`
  var tips = $(html)
  $('body').append(tips)
